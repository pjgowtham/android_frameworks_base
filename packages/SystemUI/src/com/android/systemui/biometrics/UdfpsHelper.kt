...
class UdfpsHelper(
    ...
    private val minBrightnessFloat: Float =
        context.resources.getFloat(com.android.internal.R.dimen.config_screenBrightnessSettingMinimumFloat)
    private val maxBrightnessFloat: Float =
        context.resources.getFloat(com.android.internal.R.dimen.config_screenBrightnessSettingMaximumFloat)
    ...
    private fun BrightnessToAlpha() {
        ...
        Log.i(TAG, "Brightness: $normalizedBrightness, Alpha: $currentAlpha")
    ...
    // Since we are not observing KEY_BRIGHTNESS, the display listener
    // updates brightness changes only when the slider is released. So,
