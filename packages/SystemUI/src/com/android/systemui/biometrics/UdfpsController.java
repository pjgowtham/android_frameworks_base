...
public class UdfpsController implements DozeReceiver, Dumpable {
    ...
    @NonNull private final DisplayBrightnessInteractor mDisplayBrightnessInteractor;
    ...
    public UdfpsController(@NonNull @Main Context context,
            ...
            @NonNull DisplayBrightnessInteractor displayBrightnessInteractor) {
        mContext = context;
        ...
        mDisplayBrightnessInteractor = displayBrightnessInteractor;
        mScope = scope;
