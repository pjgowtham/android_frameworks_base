                ...
                new DozeHost.PulseCallback() {
                    ...
                    public void onPulseStarted() {
                        try {
                            ...
                            if (reason == DozeLog.REASON_SENSOR_QUICK_PICKUP
                                    && mDozeParameters.shouldHideNonAuthUiOnQuickPickup()) {
                                requestState = DozeMachine.State.DOZE_PULSING_AUTH_UI;
                            } else if (com.android.systemui.Flags.newDozingKeyguardStates()) {
